...
var getHost = function () {
	return process.env.CHEDDARGETTER_HOST || "cheddargetter.com";
}

var getPort = function () {
	return process.env.CHEDDARGETTER_PORT || 443;
}
...
cheddargetter.prototype.resendInvoiceEmail = function (idOrNumber, callback) {
	var data;
